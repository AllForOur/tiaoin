...
public class FileUtil {
     ...
     * @return
     */
    public static BufferedImage getBufferedImage(String imagePath, int retryTimes, long sleep)
                                                                                              throws Exception {
    ...
    public static String getLib() {
        return StringUtil.uriDecoding(FileUtil.getParent(FileUtil.getTopClassPath(FileUtil.class),
            1) + "lib");
    }
